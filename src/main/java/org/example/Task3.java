...
public class Task3 {
    public static void main(String[] args){
        ...
        boolean workerWithSalaryMore100_000IsPresent = employeeList.stream()
                .anyMatch(employee -> employee.getSalary()>100_000.00);
        if(workerWithSalaryMore100_000IsPresent){
